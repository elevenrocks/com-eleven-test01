				...
				function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
					$.ajaxFileUpload({
						...
						success:function (obj) {
							...
							$("#imgDiv").empty();
							var imgObj = $("<img>");
							imgObj.attr("src","/mimi/image_big/"+obj.imgurl);
				...
				<form action="${pageContext.request.contextPath}/prod/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<table>
						...
						<tr>
							...
							<td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;"><img src="/mimi/image_big/${prod.pImage}" width="100px" height="100px" ></div><br><br><br><br>
